...
export class ServiceHelpers {
   ...
   */
  static pipeJsonToModel<T>(observable: Observable<T>, modelType): Observable<T>{
    return observable.pipe(map(emitted => ServiceHelpers.convertJsonToModel(emitted, modelType)));
  }
